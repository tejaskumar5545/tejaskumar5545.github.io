...
$branches_result = mysqli_query($conn, "SELECT DISTINCT branch FROM projects ORDER BY branch");
$branches = [];
...
$projects = mysqli_query($conn, "SELECT * FROM projects $where_sql ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Projects - ClassroomX</title>
...
<div class="container">
    <h2 style="font-size:28px;font-weight:700;margin-bottom:8px;color:var(--white);">Projects</h2>
    <p style="color:var(--gray-700);font-size:15px;margin-bottom:28px;">Browse project ideas, reports and references to help with your final year work.</p>
    ...
    <form method="GET" action="projects.php">
        <div class="filter-bar">
            ...
            <select name="semester">
                ...
                <option value="Semester 3" <?php echo $filter_sem === 'Semester 3' ? 'selected' : ''; ?>>Semester 3</option>
                <option value="Semester 4" <?php echo $filter_sem === 'Semester 4' ? 'selected' : ''; ?>>Semester 4</option>
                <option value="Semester 5" <?php echo $filter_sem === 'Semester 5' ? 'selected' : ''; ?>>Semester 5</option>
                <option value="Semester 6" <?php echo $filter_sem === 'Semester 6' ? 'selected' : ''; ?>>Semester 6</option>
            </select>
            <select name="branch">
            ...
            <?php if ($filter_branch !== '' || $filter_sem !== '' || $search !== ''): ?>
                <a href="projects.php" class="btn-reset">Clear</a>
            <?php endif; ?>
        </div>
    </form>

    <?php if ($projects && mysqli_num_rows($projects) > 0): ?>
        <p style="color:var(--gray-700);font-size:14px;margin-bottom:16px;">Showing <?php echo mysqli_num_rows($projects); ?> project(s)</p>
        <div class="cards">
