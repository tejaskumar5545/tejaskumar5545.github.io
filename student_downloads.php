...
$total = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as c FROM downloads WHERE student_id = $student_id"))['c'];
...
<head>
    ...
    <title>My Downloads - EngiHub</title>
    ...
    <div class="dashboard-header">
        <div>
            ...
            <p style="color:var(--gray-700);font-size:14px;margin-top:4px;">
                <?php echo $total; ?> total download<?php echo $total !== 1 ? 's' : ''; ?>
            </p>
        </div>
    ...
    <?php if ($total > 0): ?>
        <div class="table-container">
            <div class="table-responsive">
                <table>
                    ...
                    <tbody>
                        <?php $i = $offset + 1; while ($row = mysqli_fetch_assoc($downloads)): ?>
                            <tr>
                                <td><?php echo $i++; ?></td>
        ...
        <?php if ($total_pages > 1): ?>
            <div class="pagination">
                <?php if ($page > 1): ?>
                    <a href="?page=<?php echo $page - 1; ?>" class="btn btn-outline btn-sm">&laquo; Prev</a>
                <?php endif; ?>
