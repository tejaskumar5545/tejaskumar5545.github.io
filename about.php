...
<section class="hero" style="padding:60px 40px 80px;">
    <div class="hero-content">
        <h1>About <span class="highlight">EngiHub</span></h1>
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:center;margin-bottom:60px;">
            <div>
                ...
                <p style="color:var(--gray-700);font-size:16px;line-height:1.8;margin-bottom:16px;">
                    EngiHub is designed to bridge the gap between students and quality study material. We believe every student deserves easy access to organized, semester-wise notes regardless of their branch or background.
                </p>
        ...
        <div style="margin-bottom:60px;">
            <div class="director-card">
                ...
                <div class="director-info">
                    ...
                    <p class="director-desc">Leading EngiHub with a vision to make quality education accessible to every diploma student. Committed to building digital tools that empower the next generation of engineers.</p>
...
<footer>
    <p>&copy; 2026 EngiHub. All rights reserved.</p>
</footer>
