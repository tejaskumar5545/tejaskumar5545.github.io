...
<head>
    ...
    <title>Admissions - EngiHub</title>
    <meta name="description" content="Apply for admission to EngiHub. Fill out the online admission form for diploma courses.">
...
<div class="container">
    <div class="admission-hero fade-in">
        ...
        <p>Apply online for diploma programs at EngiHub. Fill out the form below and our team will reach out to you with the next steps.</p>
    </div>
    ...
    <div class="admission-form-box fade-in">
        ...
        <form method="POST" action="admission_process.php">
            ...
            <p class="required-note">By submitting this form, you agree to be contacted by the EngiHub admissions team.</p>
