...
<head>
    ...
    <title>Student Registration - EngiHub</title>
...
<div class="login-wrapper">
    <div class="login-box">
        ...
        <p class="subtitle">Create your account to track downloads</p>

        <?php if (isset($_GET['error'])): ?>
            <div class="alert alert-error">
                <?php
                switch($_GET['error']) {
                    case 'exists': echo 'Email already registered. Please login.'; break;
        ...
        <p style="text-align:center;margin-top:20px;font-size:14px;color:var(--gray-700);">
            Already have an account? <a href="student_login.php" style="color:var(--accent);font-weight:600;">Login here</a>
        </p>
    </div>
</div>
